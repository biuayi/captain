...
func run() error {
	...
	mux.HandleFunc("GET /api/v1/p/e/{event_id}/me/records", pa.MyRecords)
	...
	mux.HandleFunc("POST /api/v1/p/e/{event_id}/steps/{step_id}/draw", pa.Draw)
	mux.HandleFunc("GET /api/v1/p/e/{event_id}/steps/{step_id}/result", pa.DrawResult)
	...
	mux.Handle("POST /api/v1/org/events/{id}/lottery/audit/export", op("can_export_records", og.LotteryAuditExport))
	mux.Handle("GET /api/v1/org/events/{id}/stats", op("can_view_records", og.Stats))
	mux.Handle("GET /api/v1/org/events/{id}/warnings", op("can_view_records", og.Warnings))
	mux.Handle("POST /api/v1/org/events/{id}/warnings/export", op("can_export_records", og.WarningsExport))
